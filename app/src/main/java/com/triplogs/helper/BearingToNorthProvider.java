 ...
 */
public class BearingToNorthProvider implements SensorEventListener, LocationListener, AverageAngle.ChangeAvgListener {
    ...
    public BearingToNorthProvider(Context context, int smoothing, double minDiffForEvent, int throttleTime) {
        ...
        mAzimuthRadians = new AverageAngle(smoothing, this);
    }
    ...
    public void stop()
    {
        LogClass.e("unregisterListener","unregisterListener");
    ...
    private void updateBearing()
    {
        if (!Double.isNaN(this.mAzimuth)) {
            if(this.mLocation == null) {
                LogClass.e(TAG, "Location is NULL bearing is not true north!");
                mBearing = mAzimuth;
            } else {
